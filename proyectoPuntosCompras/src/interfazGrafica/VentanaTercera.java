...
public class VentanaTercera extends JFrame{
	...
	public void iniciarComponentes() {
		...
		JLabel etiqueta1 = new JLabel("Para registrarse, ingrese usuario y contraseña: ", SwingConstants.CENTER);	//creamos una etiqueta
		...
		JTextField cajaText3 = new JTextField("Repita la contraseña");
